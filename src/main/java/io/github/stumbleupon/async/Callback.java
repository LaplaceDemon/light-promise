 ...
 * does. If you use {@link Deferred} with {@code DEBUG} logging turned on, this
 * will be really useful to understand what's in the callback chains.
 * 
...
public interface Callback<R, T> {
    ...
    public static final Callback<Object, Object> PASSTHROUGH = new Callback<Object, Object>() {
